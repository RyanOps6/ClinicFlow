...
prompts = [
    ...
    'You are a clinic receptionist. The patient said: "555-1234". Patient name is dave. You still need their reason for visit. Write your reply as the receptionist (1-2 sentences, friendly):',
    'Extract JSON from: "my name is john". Fields: intent, full_name, phone. Use null for missing.',
]
...
for i, prompt in enumerate(prompts):
    try:
        resp = client.chat.completions.create(
            ...
            max_tokens=200 if i < 3 else 512,
            temperature=0.3,
            timeout=10
        )
