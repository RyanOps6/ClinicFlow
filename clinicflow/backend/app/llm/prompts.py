...
def build_response_prompt(workflow_context: dict) -> list[dict]:
    ...
    sys_prompt = (
        ...
        "6. If the 'fallback_template' starts with 'Here are the available slots' or contains a list of slots, you MUST include the exact phrase 'Here are the available slots for this week:' or 'Here are the available slots:' followed by the numbered list of slots copied EXACTLY (verbatim, including the exact dates, 24-hour times like 09:00, and doctor names) from the fallback_template.\n"
